...
<%
    ...
    List<User> userList = (List<User>) request.getAttribute("allAccountUsers");
    List<Task> taskList = (List<Task>) request.getAttribute("allAccountTasks");
...
<div style="border: 1px black solid; width: 40%">
    ...
    <form action="/addTask" method="post">
        ...
        <%if (user.getUserType() == UserType.EMPLOYEE && user.getStaffType() == StaffType.ACCOUNTING) {%>
...
<div style="border: 1px black solid">
    ...
    <table border="1">
        ...
        <% if (task.getUser().getStaffType() == StaffType.ACCOUNTING) {%>
        <tr>
            <td><%=task.getId()%>
            </td>
            <td><%=task.getName()%>
...
<div style="border: 1px black solid">
    ...
    <table border="1">
        ...
        <% for (User user : userList) {%>
        <%if (user.getStaffType() == StaffType.ACCOUNTING) {%>
        <tr>
            <td><%=user.getId()%>
            </td>
            <td><%=user.getName()%>
